...
@overload
def fickian_uptake(fourier_number: float | np.ndarray) -> float: ...


@overload
def fickian_uptake(fourier_number: np.ndarray) -> np.ndarray: ...


def fickian_uptake(fourier_number) -> float | np.ndarray:
...
@overload
def fickian_interface(fourier_number: float | np.ndarray) -> float: ...


@overload
def fickian_interface(fourier_number: np.ndarray) -> np.ndarray: ...


def fickian_interface(fourier_number) -> float | np.ndarray:
